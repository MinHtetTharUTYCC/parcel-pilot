...
import { LoginResponseDto, SignupResponseDto, LogoutResponseDto } from 'src/common/responses/auth-response.dto';
import { UnauthorizedResponseDto, ValidationErrorResponseDto } from 'src/common/responses/error-response.dto';
...
export class AuthController {
    ...
    @ApiOperation({
        summary: 'User Login',
        description: 'Authenticate a user with email and password. Returns access token and sets refresh token in httpOnly cookie.',
    })
    @ApiBody({
        type: LoginDto,
    ...
    @ApiOperation({
        ...
        description: 'Register a new user (resident) with email, name, unit number, and password.',
    })
    @ApiBody({
        type: SignupDto,
    ...
    @ApiOperation({
        summary: 'User Logout',
        description: 'Logout the authenticated user and clear the refresh token cookie.',
    })
    @ApiResponse({
        status: 200,
